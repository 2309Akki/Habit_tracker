// Final test with correct data structure
async function testFinalWorking() {
  ...
  try {
    ...
    // Step 3: Get categories with their MongoDB IDs
    console.log('\n3. Getting categories with MongoDB IDs...');
    ...
    if (pullData.categories && pullData.categories.length > 0) {
      ...
      const habitsData = {
        ...
        entries: [
          { id: "entry1", habitId: "habit1", date: "2026-02-10", status: "done", note: "Completed workout" }
        ]
      };
